...
class ReporteCalidad extends Component {
    ...
    render() {
        ...
        if (!this.state.loaded) {
            ...
            content = (
                <div className="ReporteCalidad-content">
                    <p>
                        <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#reporte" aria-expanded="false" aria-controls="reporte">
                            Reporte de Calidad
                        </button>
                    </p>
                    <div className="card bg-primary text-light collapse" id="reporte">
